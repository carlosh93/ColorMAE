...
<p align="center">
  ...
  <a href="MODEL_ZOO.md"><code>Model Zoo</code></a> ·
  <a href="https://huggingface.co/carlosh93/colormae"><code>Hugging Face</code></a> ·
...
**July 17, 2026**
- Safetensors are now the recommended tensor-only checkpoint format. The sibling `.pth` files are PickleScan-clean native-resume checkpoints preserving exact model, optimizer, parameter-scheduler, and epoch/iteration state. Historical scalar-log buffers were reset to remove the `HistoryBuffer` objects that caused the original warning. See the [model zoo](MODEL_ZOO.md#checkpoint-security-and-formats) for loading instructions and verification details.

**July 16, 2026**
- The complete ViT-Base [model zoo](MODEL_ZOO.md) is available on [Hugging Face](https://huggingface.co/carlosh93/colormae), including Green, Blue, Purple, and Red checkpoints for 100, 300, 800, and 1600 epochs, downstream weights, configs, scalar logs, and SHA-256 manifests. OSF remains available as an additional mirror.
...
The [ColorMAE Hugging Face repository](https://huggingface.co/carlosh93/colormae) is the canonical checkpoint archive. OSF links are intentionally retained as mirrors. See the [complete model zoo](MODEL_ZOO.md) for the recommended Green models and all Blue, Purple, and Red ablations. Safetensors are the recommended tensor-only downloads; sibling `.pth` files support direct MMEngine loading and native training resume. Every task directory includes a canonical config, with raw resolved configs and scalar-log shards under `runs/<timestamp>/`. File sizes, metrics, model/optimizer/scheduler fingerprints, local provenance, and SHA-256 checksums are recorded in the [checkpoint manifest](https://huggingface.co/carlosh93/colormae/blob/main/ViT_Base/MODEL_ZOO_MANIFEST.jsonl), [security conversion manifest](https://huggingface.co/carlosh93/colormae/blob/main/SECURITY_CONVERSION_MANIFEST.jsonl), and [artifact manifest](https://huggingface.co/carlosh93/colormae/blob/main/ViT_Base/MODEL_ZOO_ARTIFACTS_MANIFEST.jsonl).

### Hugging Face release index

| Pretraining | Pretrained | ImageNet-1K | ADE20K | COCO 768 | COCO 1024 |
| :--: | :--: | :--: | :--: | :--: | :--: |
| 100 epochs | [checkpoint](https://huggingface.co/carlosh93/colormae/resolve/main/ViT_Base/100/green/pretrain/epoch_100.safetensors?download=true) | [81.82 top-1](https://huggingface.co/carlosh93/colormae/resolve/main/ViT_Base/100/green/inet_classification/epoch_99.safetensors?download=true) | [42.24 mIoU](https://huggingface.co/carlosh93/colormae/resolve/main/ViT_Base/100/green/segmentation/iter_160000.safetensors?download=true) | [45.9 box AP / 40.9 mask AP](https://huggingface.co/carlosh93/colormae/resolve/main/ViT_Base/100/green/detection/size_768/iter_184375.safetensors?download=true) | — |
| 300 epochs | [checkpoint](https://huggingface.co/carlosh93/colormae/resolve/main/ViT_Base/300/green/pretrain/epoch_300.safetensors?download=true) | [83.01 top-1](https://huggingface.co/carlosh93/colormae/resolve/main/ViT_Base/300/green/inet_classification/epoch_98.safetensors?download=true) | [45.90 mIoU](https://huggingface.co/carlosh93/colormae/resolve/main/ViT_Base/300/green/segmentation/iter_144000.safetensors?download=true) | [48.7 box AP / 43.3 mask AP](https://huggingface.co/carlosh93/colormae/resolve/main/ViT_Base/300/green/detection/size_768/iter_184375.safetensors?download=true) | [50.4 box AP / 44.9 mask AP](https://huggingface.co/carlosh93/colormae/resolve/main/ViT_Base/300/green/detection/size_1024/iter_184375.safetensors?download=true) |
| 800 epochs | [checkpoint](https://huggingface.co/carlosh93/colormae/resolve/main/ViT_Base/800/green/pretrain/epoch_800.safetensors?download=true) | [83.61 top-1](https://huggingface.co/carlosh93/colormae/resolve/main/ViT_Base/800/green/inet_classification/epoch_99.safetensors?download=true) | [49.18 mIoU](https://huggingface.co/carlosh93/colormae/resolve/main/ViT_Base/800/green/segmentation/iter_144000.safetensors?download=true) | [49.5 box AP / 43.7 mask AP](https://huggingface.co/carlosh93/colormae/resolve/main/ViT_Base/800/green/detection/size_768/iter_184375.safetensors?download=true) | — |
| 1600 epochs | [checkpoint](https://huggingface.co/carlosh93/colormae/resolve/main/ViT_Base/1600/green/pretrain/epoch_1600.safetensors?download=true) | [83.77 top-1](https://huggingface.co/carlosh93/colormae/resolve/main/ViT_Base/1600/green/inet_classification/epoch_99.safetensors?download=true) | [49.26 mIoU](https://huggingface.co/carlosh93/colormae/resolve/main/ViT_Base/1600/green/segmentation/iter_160000.safetensors?download=true) | [50.1 box AP / 44.3 mask AP](https://huggingface.co/carlosh93/colormae/resolve/main/ViT_Base/1600/green/detection/size_768/iter_184375.safetensors?download=true) | [51.5 box AP / 45.7 mask AP](https://huggingface.co/carlosh93/colormae/resolve/main/ViT_Base/1600/green/detection/size_1024/iter_184375.safetensors?download=true) |

The detailed tables below keep `.pth` links because the documented OpenMMLab commands load them directly. Those files pass PickleScan and support native `--resume`, retaining exact model, optimizer, parameter-scheduler, and epoch/iteration state. Only historical scalar-log buffers are reset.
